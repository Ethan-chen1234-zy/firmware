...
// ==================== internal SX1262 pin（set sleep）====================
#define INTERNAL_SX126X_CS (42)      // P1.10
#define INTERNAL_SX126X_SCK (43)     // P1.11
#define INTERNAL_SX126X_MOSI (44)    // P1.12
#define INTERNAL_SX126X_MISO (45)    // P1.13
#define INTERNAL_SX126X_DIO1 (47)    // P1.15
#define INTERNAL_SX126X_BUSY (46)    // P1.14
#define INTERNAL_SX126X_RESET (38)   // P1.06
#define INTERNAL_SX126X_POWER_EN (37)
